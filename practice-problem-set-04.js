...
let derpArray = ["Blah", "Blah", "Blah", "Haha"];
...
function stringLengths(str1, str2, str3, str4) {
  let arrayOfString = [str1.length, str2.length, str3.length, str4.length];

  return arrayOfString;
}

// stringLengths('suh', 'suhdude', 'chillin', 'coding');
...
function removeFirst(array) {
  let removeFirstLitItem = array;
  removeFirstLitItem.shift();

  return removeFirstLitItem;
}
...
// swap(['unicycle', 'scooter', 'skateboard', 'canoe'], 0, 2);
// get it to return final result of: ['skateboard', 'scooter', 'unicycle', 'canoe'];
